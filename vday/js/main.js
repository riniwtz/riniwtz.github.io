let no_button = document.getElementsByClassName("no-button")[0],
    ...
    no_messages = [
        "really? :((((", "are you sure about it?", "please :(", "i'll give you one more chance", "oh :(", "i'm sorry", "are you sure?", "no cap?", "okay", "okay.", "okay..", "okay...", "\uD83D\uDE14", "wait", "please baby", "one more time", "i love you", "i miss you", "i miss your smile, eyes...", "your cute dimples", "your presence", "your everything", "no?", "catch me :(",
    ];
    var i = 0;
